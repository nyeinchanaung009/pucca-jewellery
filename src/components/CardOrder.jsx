        ...
        <div className='bg-white rounded-sm p-3 border border-shape mt-4 mb-4'>
            <div className='flex justify-start items-center pb-2'>
                ...
                <div className='font-shippori font-semibold ms-5'>
                    ...
                    <p className='text-textmute text-sm font-light mt-1'>{data.desc}</p>
            ...
            <div className='text-right border-t border-shape pt-2'>
                <button className='scale-90 font-shippori text-white bg-accent1 px-4 py-2 rounded-sm hover:bg-myorange font-bold'>Order Detail</button>
            </div>
        </div>
    )
})
