    ...
    <div className='w-11/12 sm:w-10/12 h-full mx-auto flex flex-wrap justify-center items-center'>
        ...
        <div onClick={() => filterSearch('category','necklace')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/pearl-necklace01.png" alt="necklace" />
            </div>
            <div className='-mt-1'>
        ...
        <div onClick={() => filterSearch('category','earrings')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/earrings.png" alt="earrings" />
            </div>
            <div className='-mt-1'>
        ...
        <div onClick={() => filterSearch('category','bracelet')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/bracelet (1).png" alt="bracelet" />
            </div>
            <div className='-mt-1'>
                <img className='w-6/12 mx-auto opacity-[0.6]' src="./src/assets/images/ui/foot1.png" alt="" />
            </div>
        ...
        <div onClick={() => filterSearch('category','locket')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/necklace.png" alt="locket" />
            </div>
            <div className='-mt-1'>
                <img className='w-6/12 mx-auto opacity-[0.6]' src="./src/assets/images/ui/foot1.png" alt="" />
            </div>
        ...
        <div onClick={() => filterSearch('category','ring')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/ring.png" alt="ring" />
            </div>
            <div className='-mt-1'>
                <img className='w-6/12 mx-auto opacity-[0.6]' src="./src/assets/images/ui/foot1.png" alt="" />
            </div>
        ...
        <div onClick={() => filterSearch('category','bayet')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/necklace (1).png" alt="necklace" />
            </div>
            <div className='-mt-1'>
                <img className='w-6/12 mx-auto opacity-[0.6]' src="./src/assets/images/ui/foot1.png" alt="" />
            </div>
        ...
        <div onClick={() => filterSearch('category','handchain')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/bracelet (2).png" alt="handchain" />
            </div>
            <div className='-mt-1'>
                <img className='w-6/12 mx-auto opacity-[0.6]' src="./src/assets/images/ui/foot1.png" alt="" />
            </div>
        ...
        <div onClick={() => filterSearch('category','weddingring')}  className='w-4/12 md:w-3/12 lg:w-2/12 mb-6 '>
            <div className='w-11/12 sm:w-9/12 md:w-8/12 mx-auto cardbg py-8 border border-shape group cursor-pointer duration-100'>
                <img className='w-[40px] sm:w-[56px] mx-auto opacity-[0.64] group-hover:scale-[1.15] duration-300' src="../src/assets/images/ui/wedding-rings.png" alt="wedding ring" />
            </div>
            <div className='-mt-1'>
